# Documentazione LiteStartup

Documentazione professionale per LiteStartup - Piattaforma di email marketing intelligente creata per le startup.

## Panoramica

LiteStartup è una piattaforma di email marketing SaaS progettata specificamente per le startup. Combina email aziendale (workmail), generazione di contenuti tramite AI e consegna affidabile delle email in un'unica piattaforma conveniente e facile da usare.
...
- [Sito Web LiteStartup](https://www.litestartup.com)
- [Crea account gratuito](https://app.litestartup.com/signup)
- [Dashboard](https://app.litestartup.com/dashboard)

## Caratteristiche principali

✓ **Workmail** - Email aziendale integrata (nessun Google Workspace necessario)

✓ **Assistente AI** - Genera oggetti e contenuti delle email

✓ **Automazione** - Flussi di lavoro intelligenti attivati dal comportamento dell'utente

✓ **Conveniente** - Paga per email inviata, non per contatto

✓ **Integrazione facile** - API REST semplice, funziona con qualsiasi linguaggio
...
**Pronto per iniziare?** [Crea il tuo account gratuito](https://app.litestartup.com/signup) oggi!
