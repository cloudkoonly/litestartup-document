...
Exemples de code pratiques pour intégrer LiteStartup dans votre application.
...
### Envoyer un e-mail avec un template
...
### Envoyer un e-mail avec tracking
...
### Lister des e-mails avec filtres
...
### Envoyer un e-mail depuis le front-end
...
**Suite :** Consultez [Tarifs & offres](/fr/05-pricing.md) ou relisez le [Guide des fonctionnalités](/fr/03-features.md) !
